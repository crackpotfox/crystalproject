MoveReminder:
	...
	; Places money top right corner of screeen
...
.loop_party_menu
	...
	call PrintText
;fall through to loop_move_menu
; begin move menu loop
...
; Loads and prints the "MoveReminderEggText" text, waits for button. Then rel jump to .loop_party_menu.
.is_an_egg
	ld hl, MoveReminderEggText
	call PrintText
	jr .loop_party_menu

; Loads and prints the "MoveReminderNotaMonText" text, waits for input, jump to loop_party_menu.
.not_a_pokemon
	ld hl, MoveReminderNotaMonText
	call PrintText
	jr .loop_party_menu

; Loads and prints the "MoveReminderNoMovesText" text, button press, then loop back to party menu.
.no_moves_to_learn
