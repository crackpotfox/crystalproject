...
; 100% chance to greatly encourage stat-up moves if the player is flying or undergound, and the enemy is faster
; 100% chance to greatly discourage stat-down moves if player has Mist or Substitute up
