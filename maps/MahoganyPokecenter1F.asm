	...
	const MAHOGANYPOKECENTER1F_TRADEBACKNPC
...
MahoganyPokecenter1F_MapEvents:
	...
	object_event 6,	1,	SPRITE_GAMEBOY_KID, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TradebackNPCScript, -1
