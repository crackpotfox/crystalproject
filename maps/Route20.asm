...
Route20_MapEvents:
	...
	warp_event 32,  5, SEAFOAM_1F,  1
	warp_event 40,  7, SEAFOAM_1F,  2
...
;	object_event 30, 6, SPRITE_BIRD, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route20ArticunoScript, EVENT_FOUGHT_ARTICUNO
