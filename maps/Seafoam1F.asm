...
.StoneTable:
	stonetable 3, SEAFOAM1F_BOULDER1, .Boulder1
	stonetable 4, SEAFOAM1F_BOULDER2, .Boulder2
	db -1 ; end

.Boulder1:
	disappear SEAFOAM1F_BOULDER1
	clearevent EVENT_BOULDER_SEAFOAM1F_BOULDER1
	setevent EVENT_BOULDER_SEAFOAM2F_BOULDER1
	sjump .FinishBoulder

.Boulder2:
	disappear SEAFOAM1F_BOULDER2
	clearevent EVENT_BOULDER_SEAFOAM1F_BOULDER2
...
Seafoam1F_MapEvents:
	...
	def_object_events
	object_event x, y, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Seafoam1FBoulder, EVENT_BOULDER_SEAFOAM1F_BOULDER1
	object_event x, y, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Seafoam1FBoulder, EVENT_BOULDER_SEAFOAM1F_BOULDER2
