...
ElmsLab_MapEvents:
	...
	object_event 0, 3, SPRITE_RED, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ElmsLabWillScript, EVENT_ARCHITECTS

	object_event 0, 4, SPRITE_RED, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ElmsLabMalyScript, EVENT_ARCHITECTS
	
	object_event 0, 5, SPRITE_RED, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, ElmsLabKevinScript, EVENT_ARCHITECTS
