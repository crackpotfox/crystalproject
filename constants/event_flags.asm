...
; Johto story events
	...
	const EVENT_FOUGHT_ARTICUNO ; unused
	const EVENT_FOUGHT_MEW ; unused
...
; Kanto hidden items
	...
	const EVENT_PPBASEMENT_LIGHTBALL
	const EVENT_PPBASEMENT_MAGNET
	const EVENT_PPBASEMENT_METAL_COAT
	const EVENT_PPBASEMENT_THUNDERSTONE
	const EVENT_PPBASEMENT_UPGRADE
...
; New to Crystal
	const EVENT_RECIEVED_BULBASAUR
	const EVENT_RECIEVED_CHARMANDER
	const EVENT_RECIEVED_SQUIRTLE
	const EVENT_RECIEVED_CHIKORITA
	const EVENT_RECIEVED_CYNDAQUIL
	const EVENT_RECIEVED_TOTODILE
	const EVENT_BOULDER_SEAFOAM1F_BOULDER1
	const EVENT_BOULDER_SEAFOAM1F_BOULDER2
	const EVENT_BOULDER_SEAFOAM2F_BOULDER1
	const EVENT_BOULDER_SEAFOAM2F_BOULDER2	
	const EVENT_BOULDER_SEAFOAM3F_BOULDER1
	const EVENT_BOULDER_SEAFOAM3F_BOULDER2
	const EVENT_BOULDER_SEAFOAM4F_BOULDER1
	const EVENT_BOULDER_SEAFOAM4F_BOULDER2
	const EVENT_BOULDER_SEAFOAM4F_BOULDER3
	const EVENT_BOULDER_SEAFOAM4F_BOULDER4
	const EVENT_BOULDER_SEAFOAM5F_BOULDER1
	const EVENT_BOULDER_SEAFOAM5F_BOULDER2
	const EVENT_SEAFOAM3F_MAX_ELIXER
	const EVENT_SEAFOAM4F_MAXELIXER
	const EVENT_SEAFOAM5F_ULTRABALL
	...
	const EVENT_CERULEAN3FPPUP
	const EVENT_CERULEAN1FPPUP
	const EVENT_CERULEAN1FRARECANDY
	const EVENT_CERULEAN1FMAXREVIVE
	const EVENT_CERULEAN1FULTRABALL
	const EVENT_CERULEAN1FMAXELIXER
	const EVENT_CERULEAN3F_ULTRABALL
	const EVENT_CERULEAN2FFULLRESTORE	
	const EVENT_CERULEAN2FULTRABALL
	const EVENT_CERULEAN2FMAXREVIVE
	const EVENT_CERULEAN2FRARECANDY
	const EVENT_CERULEAN3F_MAXREVIVE
	const EVENT_CERULEAN3F_MAXELIXER
	const EVENT_CERULEAN3F_ULTRABALL2
	const EVENT_CERULEAN2FPPUP
	const EVENT_ARCHITECTS
