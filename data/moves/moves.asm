...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          20, NORMAL,       100, 15,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          20, NORMAL,       100, 15,   0
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         95, NORMAL,       100, 15,   0
	...
	move VICEGRIP,     EFFECT_PARALYZE_HIT,       70, BUG,          100, 30,  10
	move GUILLOTINE,   EFFECT_OHKO,                0, NORMAL,        30,  5,   0
	move RAZOR_WIND,   EFFECT_NORMAL_HIT,         80, FLYING,       100, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         75, GRASS,        100, 30,   0
	...
	move SLAM,         EFFECT_REVERSAL,           60, NORMAL,       100, 20,   0
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         40, GRASS,        100, 25,   0
	move STOMP,        EFFECT_STOMP,              65, NORMAL,       100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         35, FIGHTING,     100, 30,   0
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, NORMAL,        80,  5,   0
	move JUMP_KICK,    EFFECT_JUMP_KICK,          70, FIGHTING,      95, 25,   0
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         85, FIGHTING,      85, 15,  30
	...
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, NORMAL,        90, 20,   0
	move THRASH,       EFFECT_RAMPAGE,            95, NORMAL,       100, 20,   0
	...
	move ACID,         EFFECT_POISON_HIT,         60, POISON,       100, 30,  10
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,         90, FIGHTING,      90, 25,   0
	move LOW_KICK,     EFFECT_SPEED_DOWN_HIT,     55, FIGHTING,     100, 20, 100
	...
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         60, ROCK,         100, 15,   0
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,        100, GROUND,       100, 10,   0
	move FISSURE,      EFFECT_EARTHQUAKE,        120, GROUND,        80,  5,   0
	...
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,       100, 40,   0
	...
	move SMOG,         EFFECT_POISON_HIT,         50, POISON,       100, 20,  40
	move SLUDGE,       EFFECT_POISON_HIT,         75, POISON,       100, 20,  30
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         70, GROUND,       100, 20,  10
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,          80,  5,  10
	move WATERFALL,    EFFECT_FLINCH_HIT,          80, WATER,        100, 15,  10
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,         85, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,       100, 20,   0
	move SKULL_BASH,   EFFECT_FLINCH_HIT,         70, GROUND,       100, 15,  10
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          25, NORMAL,       100, 15,   0
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     60, POISON,       100, 35,  10
	...
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, GHOST,        100, 15,   0
	move POISON_GAS,   EFFECT_POISON,              0, POISON,        80, 40,   0
	move BARRAGE,      EFFECT_MULTI_HIT,          25, FIRE,          85, 20,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          40, BUG,          100, 15,   0
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,        75, 10,   0
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        120, FLYING,        80,  5,   0
	...
	move PSYWAVE,      EFFECT_CONFUSE_HIT,        60, GHOST,        100, 20,   0
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,       100, 40,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,       100, 40,   0
	move CRABHAMMER,   EFFECT_DEFENSE_UP_HIT,     90, WATER,        100, 10,  10
	move EXPLOSION,    EFFECT_SELFDESTRUCT,      250, NORMAL,       100,  5,   0
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          20, NORMAL,        80, 15,   0
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         35, GROUND,       100, 10,   0
	move REST,         EFFECT_HEAL,                0, PSYCHIC_TYPE, 100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,         100, 10,  30
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,       100, 15,  10
	...
	move AEROBLAST,    EFFECT_PARALYZE_HIT,      100, FLYING,        95,  5,  10
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  35, GROUND,       100, 10, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,        100, 10,  50
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     60, ICE,          100, 15, 100
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          80, GRASS,        100, 15,   0
	...
	move MEGAHORN,     EFFECT_NORMAL_HIT,        120, BUG,           80, 10,   0
	...
	move IRON_TAIL,    EFFECT_ATTACK_UP_HIT,      95, STEEL,        100, 15,  10
	...
	move SHADOW_BALL,  EFFECT_CONFUSE_HIT,        80, GHOST,        100, 15,  10
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        40, WATER,         90, 15,   0
