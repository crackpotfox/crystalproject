...
MapGroup_Dungeons:
	...
	map Seafoam1F, TILESET_SEAFOAM, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam2F, TILESET_SEAFOAM, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam3F, TILESET_SEAFOAM, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam4F, TILESET_SEAFOAM, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam5F, TILESET_SEAFOAM, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MoltresChamber, TILESET_DARK_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DARK_CAVE, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_4, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map CeruleanCave3F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_4, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_4, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map ViridianForest, TILESET_VFOREST, CAVE, LANDMARK_VFOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Cerulean:
	...
	map PowerPlantBasement, TILESET_FACILITY, DUNGEON, LANDMARK_POWER_PLANT, MUSIC_ROCKET_HIDEOUT,  TRUE, PALETTE_DAY, FISHGROUP_SHORE
