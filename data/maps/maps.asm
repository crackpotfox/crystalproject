...
MapGroup_Dungeons:
	...
	map Seafoam1F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam2F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam3F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam4F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map Seafoam5F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_20, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map MoltresChamber, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DARK_CAVE, TRUE, PALETTE_DARK, FISHGROUP_SHORE
