...
Rival1Group:
	...
	db 40, SNEASEL,    ICY_WIND, QUICK_ATTACK, ICE PUNCH, FAINT_ATTACK
	...
	db 47, SNEASEL,    ICE_PUNCH, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 43, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 43, SEADRA,   DRAGON_BREATH, WHIRLPOOL, SURF, SLUDGE
	db 44, HAUNTER,    HYPNOSIS, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 44, KADABRA,    DISABLE, PSYBEAM, RECOVER, THUNDER_PUNCH
